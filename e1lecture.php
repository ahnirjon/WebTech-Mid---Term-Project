<html>
	<head>
		<title>Lecture Notes:English 1</title>
	</head>
	<body>
		<form>
			...
			<table border="0" width="100%">
				...
				<td>
					<table border="0" width="100%">
						<td bgcolor="#553819" width="100%"><h2>English 1</h2>	
					...
					<table>
						<td width="30%" valign="top">
							<a href="e1syllabus.php">Syllabus</a></br>
							<a href="e1lecture.php">Leture Notes</a></br>
							<a href="e1assignment.php">Assignments</a></br>
							<a href="e1exams.php">Exams</a>
