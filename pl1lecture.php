<html>
	<head>
		<title>Lecture Notes:Programming Language 1</title>
	</head>
	<body>
		<form>
			...
			<table border="0" width="100%">
				...
				<td>
					<table border="0" width="100%">
						<td bgcolor="#553819" width="100%"><h2>Programming Language 1</h2>	
					...
					<table>
						<td width="30%" valign="top">
							<a href="pl1syllabus.php">Syllabus</a></br>
							<a href="pl1lecture.php">Leture Notes</a></br>
							<a href="pl1assignment.php">Assignments</a></br>
							<a href="pl1exams.php">Exams</a>

						</td>
						<td>
							<table border="1" width = "100%">
								<th bgcolor="red">WEEK#</th>
								<th bgcolor="red">TOPICS</th>
								<tr><td>1</td><td>basics(pdf)</td></tr>
								<tr><td>2</td><td>abc(pdf)</td></tr>
								<tr><td>3</td><td>efg(pdf)</td></tr>
								<tr><td>4</td><td>qwerty(pdf)</td></tr>
							</table>
						</td>				
