		...
		<form>
			...
			<table border="0" width="100%">
				...
				<td>
					<table border="0" width="100%">
						<td><nav>
							<a href="addlecturenotes.php">Add Lecture Notes:</a></nav><br> |
							<form>
  								Add Lecture Notes:
  								<input type="text" name="Lecture Notes"><br>
						...
						<table border="0">
							...
							<tr>
								<td>
									...
									<img src="accenture.png" width="150" height="70" alt="Click to visit our facebook page">
									</a>
									<a href="https://www.mathworks.com/">
									<img src="mathworks.png" width="150" height="70" alt="Click to visit our facebook page">
									</a><br/>
									<a href="https://www.dow.com/en-us/">
									<img src="dow.png" width="150" height="70" alt="Click to visit our facebook page">
									</a>
									<a href="http://www.abinitio.com/en/">
									<img src="abinito.png" width="150" height="70" alt="Click to visit our facebook page">
									</a>
								</td>
							</tr>
						</table>
