<html>
	<head>
		<title>Assignments:Accounting</title>
	</head>
	<body>
		<form>
				...
				<tr height="15%" bgcolor="#553819">
					...
					<td valign="top"> <h2> <b> <font color="#ec9000">E-VARSITY</font><font color="white">OPENCOURSEWARE</font> </b> </h2>
						<td width="30%" valign="top" align="right">
							...
							<a href="homePage.php"><font color="white">Logout</font></a>&nbsp;&nbsp;<font color="white">|</font>&nbsp;&nbsp;
			...
			<table border="0" width="100%">
				<tr height="7" bgcolor="#3d1f05">
					...
					<td>
						<a href="findCourses.php"><font color="lightBlue"> <h3>Find course</h3> </font></a>
					</td>
					<td width="20%"></td>
				</tr>
			</table>
			<table border="0" width="100%">
				...
				<td>
					<table border="0" width="100%">
						<td bgcolor="#553819" width="100%"><h2>Accounting</h2>	
					...
					<table>
						<td width="30%" valign="top">
							<a href="accsyllabus.php">Syllabus</a></br>
							<a href="acclecture.php">Leture Notes</a></br>
							<a href="accassignment.php">Assignments</a></br>
							<a href="accexams.php">Exams</a>

						</td>
						<td>
							<table border="1" width = "75%">
								<th bgcolor="red">ASSIGNMENTS</th>
								<th bgcolor="red">SOLUTIONS</th>
								<tr><td>Assignment 1(pdf)</td><td>pdf</td></tr>
								<tr><td>Assignment 2(pdf)</td><td>pdf</td></tr>
							</table>
						</td>				
